...
const avery = Person("Avery", 20, "Dark Chocolate"); //undefined
const jackie = new Person("Jackie", 35, "Sourdough Bread");
...
// printProtoTypeChain(avery); //THIS WILL  thow error because we are reading property of undefined
printProtoTypeChain(jackie);
